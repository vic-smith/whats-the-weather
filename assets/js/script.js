...
var getWeather = function (event) {
  ...
  //create search button from storage
  var history = localStorage.getItem("City", inputCity);
  var searchbtn = document.createElement("button");
  searchbtn.classList = "btn";
  searchbtn.textContent = history;
  document.getElementById("cities").appendChild(searchbtn);
  console.log(history);
    ...
    .then(function (data) {
      ...
      fetch(apiUrl2)
        ...
        .then(function (data2) {
          ...
          document.getElementById("fiveDay").appendChild(current);
          ...
          for (var i = 0; i < 5; i++) {
            ...
            var dt = data2.daily[i].dt
            console.log(temp1, wind1, humidity1, uv1)

            var card = document.createElement("div");
            card.classList = "cards cell";
            ...
            var newdate = moment.unix(dt).format("MMM D, YYYY")
